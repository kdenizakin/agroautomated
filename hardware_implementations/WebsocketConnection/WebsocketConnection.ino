...
void loop() {
  ...
  while(NodeMCU.available()>0){ //eğer burada Arduinoya bir data transferi varsa condition satisfied.
    sensorValues = NodeMCU.readString(); //PC'den gelen veriyi val'a kaydediyor.
